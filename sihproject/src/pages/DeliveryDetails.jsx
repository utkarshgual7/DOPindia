...
const DeliveryDetails = () => {
  ...
  return (
    <div className="flex flex-col pt-5 pl-7 bg-white max-md:pl-5">
      <Navbar />
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center min-h-screen p-4">
          <h1 className="text-4xl font-bold leading-none text-center bg-clip-text text-transparent bg-gradient-to-r from-[#f57070] to-[#BE1515] mb-8">
            Kindly Fill in Recipient Details
          </h1>
          <div className="flex flex-col w-full lg:w-6/12 max-w-4xl bg-gradient-to-r from-[#f57070] to-[#922a2a] rounded-[20px] shadow-md p-8">
